...
\033[1;91m          @@@...............Zabi............@@@ \033[1;0m

\033[1;97m         @@@...............Khan...........@@@ \033[1;0m
...
\033[1;93m(!)\033[1;97m Author   : Zabi-Khan

\033[1;93m(!)\033[1;97m Github   : https://github.com/Tech-abm

\033[1;93m(!)\033[1;97m Fb Id  : https://m.facebook.com/zohaibkhan.jadoon.10
...
def user_info():
    ...
    try:
        ...
        zabi = open("/sdcard/.zabi.txt", "r").read()
...
def login_fb():
    ...
    if "loc" in q:
        ...
        login_zabi = open('access_token.txt', 'w')

        login_zabi.write(q["loc"])
